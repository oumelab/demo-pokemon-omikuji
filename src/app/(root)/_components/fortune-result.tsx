...
export default function FortuneResult({ fortune }: FortuneResultProps) {
  return (
    <Card className="w-full max-w-md bg-white pt-0 shadow-lg rounded-xl border-2 border-gold animate-glow">
      <CardHeader className="bg-red-600 py-4 text-white rounded-t-xl">
