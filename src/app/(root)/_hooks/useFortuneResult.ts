...
export default function useFortuneResult() {
  const [isDrawing, setIsDrawing] = useState(false); // おみくじを引いている最中かどうか
  const [fortune, setFortune] = useState<FortuneResult>(); // おみくじの結果(運勢レベルとポケモン)
